<?php
    ...
    class galleryImg {
        ...
        function __construct($title, $img_src, $thumbnail_src){
    ...
    $gallery[] = new galleryImg(
        "Khyentse Rinpoche holding drawings from the children, inspired by 84000’s translation of the Lalitavistara. Photo: Pema Abrahams",
        "http://84000.co/wp-content/gallery/2016-11-bodhgaya-resounding/DKRkidsdrawingsinhand-PA.jpg",
        "http://84000.co/wp-content/gallery/2016-11-bodhgaya-resounding/thumbs/thumbs_DKRkidsdrawingsinhand-PA.jpg"
    );
    $gallery[] = new galleryImg(
        "Khyentse Rinpoche addresses the monastics in Tibetan on the importance of translating the Kangyur into English. Photo: Pema Abrahams",
        "http://84000.co/wp-content/gallery/2016-11-bodhgaya-resounding/DKRmicrophone-PA.jpeg",
        "http://84000.co/wp-content/gallery/2016-11-bodhgaya-resounding/thumbs/thumbs_DKRmicrophone-PA.jpeg"
               
    );
    $gallery[] = new galleryImg(
        "Children offer drawings of the life of the Buddha to Khyentse Rinpoche. Photo: Pema Abraham",
        "http://84000.co/wp-content/gallery/2016-11-bodhgaya-resounding/KidsdrawingDKR2-PA.jpg",
        "http://84000.co/wp-content/gallery/2016-11-bodhgaya-resounding/thumbs/thumbs_KidsdrawingDKR2-PA.jpg"
    );
    $gallery[] = new galleryImg(
        "Children offer drawings of the life of the Buddha to Khyentse Rinpoche. Photo: Pema Abrahams",
        "http://84000.co/wp-content/gallery/2016-11-bodhgaya-resounding/KidsdrawingtoDKR-PA.jpg",
        "http://84000.co/wp-content/gallery/2016-11-bodhgaya-resounding/thumbs/thumbs_KidsdrawingtoDKR-PA.jpg"
    );
    $gallery[] = new galleryImg(
        "Children read from 84000’s The Play In Full to a captive audience. Photo: Pema Abrahams",
        "http://84000.co/wp-content/gallery/2016-11-bodhgaya-resounding/Kids2-PA.jpg",
        "http://84000.co/wp-content/gallery/2016-11-bodhgaya-resounding/thumbs/thumbs_Kids2-PA.jpg"
    );
    $gallery[] = new galleryImg(
        "Khyentse Rinpoche leads the resounding. Photo: Pema Abrahams",
        "http://84000.co/wp-content/gallery/2016-11-bodhgaya-resounding/DKRresound-PA.jpg",
        "http://84000.co/wp-content/gallery/2016-11-bodhgaya-resounding/thumbs/thumbs_DKRresound-PA.jpg"
    );
    $gallery[] = new galleryImg(
        "",
        "http://84000.co/wp-content/gallery/2016-11-bodhgaya-resounding/IMG_0516.JPG",
        "http://84000.co/wp-content/gallery/2016-11-bodhgaya-resounding/thumbs/thumbs_IMG_0516.JPG"
    );
    $gallery[] = new galleryImg(
        "",
        "http://84000.co/wp-content/gallery/2016-11-bodhgaya-resounding/IMG_0517.JPG",
        "http://84000.co/wp-content/gallery/2016-11-bodhgaya-resounding/thumbs/thumbs_IMG_0517.JPG"
    );
    $gallery[] = new galleryImg(
        "",
        "http://84000.co/wp-content/gallery/2016-11-bodhgaya-resounding/IMG_0514.JPG",
        "http://84000.co/wp-content/gallery/2016-11-bodhgaya-resounding/thumbs/thumbs_IMG_0514.JPG"
    );
    $gallery[] = new galleryImg(
        "Photo: Preetu Chauhan",
        "http://84000.co/wp-content/gallery/2016-11-bodhgaya-resounding/ResoundingParticipantText.jpg",
        "http://84000.co/wp-content/gallery/2016-11-bodhgaya-resounding/thumbs/thumbs_ResoundingParticipantText.jpg"
    );
    $gallery[] = new galleryImg(
        "84000 Team Members pose with gold-bound Resounding texts. Photo: Mumu",
        "http://84000.co/wp-content/gallery/2016-11-bodhgaya-resounding/84000teamBgaya-MuMu.jpg",
        "http://84000.co/wp-content/gallery/2016-11-bodhgaya-resounding/thumbs/thumbs_84000teamBgaya-MuMu.jpg"
    );
        ...
        <div class="col-md-9 col-md-merge-right">
            <div class="panel panel-default foreground">
                <article class="panel-body">
                    ...
                    <h1>84000’s Third Resounding Under the Bodhi Tree</h1>

                    <p>On Thursday, November 10th, Dzongsar Khyentse Chokyi Lodro Institute (DKCLI) and 84000 jointly hosted the “Third Resounding Under the Bodhi Tree” at the Mahabodhi Temple in Bodhgaya, India. The event took place on the concluding day of the 10-day Dzongsar Monlam, and about 1,000 monks and 500 lay attendees participated. Led by Dzongsar Khyentse Rinpoche, Chair of 84000, participants read from two of 84000’s newly translated texts:</p>

                    <ul>
                        <li>
                            <a href="#">The Question of Maitreya (Toh 85)</a>
                        </li>
                        <li>
                            <a href="#">The Question of Maitreya on the Eight Qualities (Toh 86)</a>
                        </li>
                    </ul>
                    ...
                    <h3>Rinpoche’s Speech at Third Bodhi Tree Resounding</h3>

                    <figure>
                        <div class="embed-responsive embed-responsive-16by9">
                            <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/kIa1pzRcgyY" allowfullscreen></iframe>
                        </div>

                        <figcaption>
                            More videos available on our <a href="#">YouTube</a> and <a href="#">Vimeo</a> channels.
                        </figcaption>
                    </figure>

                    <ul class="nav nav-tabs">
                        <li role="presentation" class="active">
                            <a href="#en-speech" aria-controls="en-speech" role="tab" data-toggle="tab">English</a>
                        </li>
                        <li role="presentation">
                            <a href="#bo-speech" aria-controls="bo-speech" role="tab" data-toggle="tab">Tibetan</a>
                        </li>
                    </ul>

                    <div class="tab-content">
                        <div role="tabpanel" class="tab-pane active" id="en-speech">
                        ...
                        <div role="tabpanel" class="tab-pane text-bo" id="bo-speech">
                ...
                <div class="panel-footer">
                    <div class="row prev-next">
                        <div class="col-sm-6">
                            <a href="#"><i class="fa fa-caret-left" aria-hidden="true"></i>The Title of the Previous Article</a>
                        </div>
                        <div class="col-sm-6 text-right">
                            <a href="#">The Title of the Next Article<i class="fa fa-caret-right" aria-hidden="true"></i></a>
                        </div>
                    </div>
                </div>
