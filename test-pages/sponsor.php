                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="form-group">
                                    <label for="amount1" class="col-sm-3 control-label">Select amount</label>
                                    <div class="col-sm-4">
                                        <div class="radio">
                                            <label>
                                ...
                                <div class="form-group collapse persist" id="otherAmountContainer">
                                    <label for="otherAmount" class="col-sm-3 control-label">Enter US$ amount</label>
                                    <div class="col-sm-3">
                                ...
                                <div class="form-group">
                                    <label for="Single" class="col-sm-3 control-label">One-time or recurring</label>
                                    <div class="col-sm-9">
                                        <div class="radio">
                                            <label>
                                ...
                                <div class="collapse persist" id="dedicationContainer">
                                    ...
                                    <div class="form-group">
                                        <label for="occasion" class="col-sm-3 control-label">Occasion</label>
                                        <div class="col-sm-9">
                                    ...
                                    <div class="form-group">
                                        <label for="dedicationName" class="col-sm-3 control-label">Dedicated to</label>
                                        <div class="col-sm-9">
                                    ...
                                    <div class="collapse persist" id="ecardContainer">
                                        ...
                                        <div class="form-group">
                                            <label for="ecardName" class="col-sm-3 control-label">eCard Recipient</label>
                                            <div class="col-sm-9">
                                        ...
                                        <div class="form-group">
                                            <label for="ecardEmail" class="col-sm-3 control-label">Recipient email</label>
                                            <div class="col-sm-9">
                                        ...
                                        <div class="form-group">
                                            <label for="ecardMessage" class="col-sm-3 control-label">Message</label>
                                            <div class="col-sm-9">
                                ...
                                <?php if($_GET['lang'] !== 'zh') { ?>
                                    ...
                                    <div class="form-group">
                                        <label for="lname" class="col-sm-3 control-label">Family name</label>
                                        <div class="col-sm-6">
                                ...
                                <?php } else { ?>
                                    ...
                                    <!-- Chinese name -->
                                    <div class="form-group">
                                        <label for="chineseName" class="col-sm-3 control-label">Name</label>
                                        <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <label for="phone" class="col-xs-12 col-sm-3 control-label">Tel. (optional)</label>
                                ...
                                <div class="tabs-container top-margin">
                                    ...
                                    <div class="tab-content">
                                        <div role="tabpanel" class="tab-pane active" id="payment-cc">
                                            ...
                                            <div class="form-group">
                                                <label for="cardName" class="col-sm-3 control-label">Name on card</label>
                                                <div class="col-sm-6">
                                            ...
                                            <div class="form-group">
                                                <label for="expiryMonth" class="col-xs-12 col-sm-3 control-label">Expiry</label>
                                        ...
                                        <div role="tabpanel" class="tab-pane" id="payment-ft">
                                            ...
                                            <div class="form-group">
                                                <label for="accountType" class="col-sm-3 control-label">Account Type</label>
                                                <div class="col-sm-3">
                                                    <div class="radio">
                                                        <label>
                                            ...
                                            <div class="form-group">
                                                <label for="accountName" class="col-sm-3 control-label">Name on account</label>
                                                <div class="col-sm-6">
                                            ...
                                            <div class="form-group">
                                                <label for="routingNumber" class="col-sm-3 control-label">Routing number</label>
                                                <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            <label for="address1" class="col-sm-3 control-label">Billing address</label>
                                            <div class="col-sm-8">
                                        ...
                                        <div class="form-group">
                                            <label for="address2" class="col-sm-3 control-label">Line 2 (optional)</label>
                                            <div class="col-sm-8">
                                        ...
                                        <div class="form-group">
                                            <label for="addressCity" class="col-sm-3 control-label">City (optional)</label>
                                            <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            <label for="addressCountry" class="col-sm-3 control-label">Country</label>
                                            <div class="col-sm-8">
                                        ...
                                        <div class="form-group">
                                            <label for="addressState" class="col-sm-3 control-label">State / province (optional)</label>
                                            <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            <label for="addressZip" class="col-sm-3 control-label">Postcode / Zip</label>
                                            <div class="col-sm-4">
