        ...
        <div class="col-sm-12">
            ...
            <div class="panel panel-default">
                    ...
                    <ul class="nav nav-tabs nav-justified">
                        <li role="presentation" class="active">
                            <a href="#kangyur" aria-controls="kangyur" role="tab" data-toggle="tab">
                                <div class="title">The Kangyur</div>
                                <p class="text-bo">བཀའ་འགྱུར།</p>
                                <p>The collected scriptures: the Tibetan translations of the Indian texts that are considered to be the words of the Buddha.</p>
                            </a>
                        </li>
                        <li role="presentation">
                            <a href="#tengyur" aria-controls="tengyur" role="tab" data-toggle="tab">
                                <div class="title">The Tengyur</div>
                                <p class="text-bo">བསྟན་འགྱུར།</p>
                                <p>The collected treatises: the Tibetan translations of scriptural works by the great Indian Buddhist masters.</p>
                            </a>
                        </li>
                    </ul>
                </div>
                ...
                <div class="tab-content">
                    ...
                    <div role="tabpanel" class="tab-pane fade in active" id="kangyur">
                        <div class="panel-body">
                            ...
                            <div class="row">
                                <div class="col-lg-3 col-sm-6">
                                    <div class="section-panel">
                                        ...
                                        <div data-match-height="kangyur-section">
                                            <a href="/?template=reading-room-list" target="_self" class="block-link">
                                                <h3 class="title">Discipline</h3>
                                                <p class="title">
                                                    <span class="text-bo">འདུལ་བ།</span> 'dul ba
                                                </p>
                                                <p class="title">Vinaya</p>
                                                <p class="notes">
                                ...
                                <div class="col-lg-3 col-sm-6">
                                    <div class="section-panel">
                                        ...
                                        <div data-match-height="kangyur-section">
                                            <a href="/?template=reading-room-list" target="_self" class="block-link">
                                                <h3 class="title">Discourses</h3>
                                                <p class="title">
                                                    <span class="text-bo">མདོ།</span> mdo
                                                </p>
                                                <p class="title">Sūtra</p>
                                                <p class="notes">
                                ...
                                <div class="col-lg-3 col-sm-6">
                                    <div class="section-panel">
                                        ...
                                        <div data-match-height="kangyur-section">
                                            ...
                                            <a href="/?template=reading-room-list" target="_self" class="block-link">
                                                <h3 class="title">Tantra</h3>
                                                <p class="title">
                                                    <span class="text-bo">རྒྱུད།</span> rgyud
                                                </p>
                                                <p class="title">Tantra</p>
                                                <p class="notes">
                                ...
                                <div class="col-lg-3 col-sm-6">
                                    <div class="section-panel">
                                        ...
                                        <div data-match-height="kangyur-section">
                                            <a href="/?template=reading-room-list" target="_self" class="block-link">
                                                <h3 class="title">Incantations</h3>
                                                <p class="title">
                                                    <span class="text-bo">གཟུངས།</span> gzungs
                                                </p>
                                                <p class="title">Dhāraṇī</p>
                                                <p class="notes">
                                                    Short sūtra or tantra texts used mainly for ritual purposes, mostly structured around an incantation in Sanskrit, its uses and the story of its origin (Toh 846-1108).
                                                </p>
                                            </a>
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-lg-offset-3 col-sm-8 col-sm-offset-2">
                                    <div class="section-panel">
                                        ...
                                        <div>
                                            <a href="/?template=reading-room-list" target="_self" class="block-link">
                                                <h3 class="title">Kangyur Catalogue</h3>
                                                <p class="title">
                                                    <span class="text-bo">བཀའ་འགྱུར་དཀར་ཆག</span> bka' 'gyur dkar chag
                                                </p>
                                                <p class="notes">
                            ...
                            <article id="kangyur-description">
                                
                                <h3>The Kangyur and its divisions</h3>
                                <section class="row">
                                    <div class="col-sm-8">
                                        <p>
                                        ...
                                        <p>
                                            The order of the sections and texts here follows that of the Degé Kangyur, and the individual texts have been numbered according to the widely used Tōhoku catalogue, which also follows the order of the Degé Kangyur and Tengyur (Ui, H. et al. eds. A Complete Catalogue of the Tibetan Buddhist Canons. 1934: Sendai, Japan. Tōhoku Imperial University.)
                                        </p>
                                    </div>
                                    <div class="col-sm-4">
                                        <figure>
                                            <a href="imgs/text7.jpg" 
                                                data-lightbox="slideshow" 
                                                data-title="Caption for image 1" 
                                                title="Caption for image 1">
                                                <img src="imgs/text7.jpg" class="img-responsive">
                                            </a>
                                ...
                                <section class="row">
                                    <div class="col-sm-8">
                                        ...
                                        <p>
                                            Outlying, local Kangyurs have come to light in recent decades (e.g. the Phuktrak, Newark Batang, and Tapho manuscripts) whose contents may reflect earlier stages of the independent circulation of collections of translated texts.</p>
                                        </p>
                                    </div>
                                    <div class="col-sm-4">
                                        <figure>
                                            <a href="imgs/text15.jpg" 
                                                data-lightbox="slideshow" 
                                                data-title="Caption for image 2" 
                                                title="Caption for image 2">
                                                <img src="imgs/text15.jpg" class="img-responsive">
                                            </a>
                    ...
                    <div role="tabpanel" class="tab-pane fade" id="tengyur">

                        <div class="panel-body">

                            Please use The Kangyur tab as a reference of how it should look.
